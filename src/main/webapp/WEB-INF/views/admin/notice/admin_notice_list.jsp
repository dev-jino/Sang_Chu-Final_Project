						...
						<div class="main">
							...
							<section class="left_main">
								<div class="comunity_content_title_area_policy">
									<img class="comunity_title_img" src="<%=request.getContextPath()%>/img/site/notice.png" alt="내용 타이틀 이미지" style="width: 30px;"/>
									<span>공지사항관리</span>
								</div>
								<br>
									...
									<table class="admin_notice_table">
										...
										<tr>
											...
											<td class="faq_list_td" width="60%">
												<a href="상세페이지로 이동">제목(상세페이지로 이동)</a>
											</td>
											<td class="faq_list_td" width="10%">함경식</td>
											<td class="faq_list_td" width="10%">2000.12.31</td>
											<td class="faq_list_td" width="10%">
												<option></option>
											</td>
										</tr>
								...
								<div class="write_btn_div">
									<button class="write_btn" type="button" onclick="location.href='<%=request.getContextPath()%>/admin_notice_write'">글작성</button>
								</div>							
