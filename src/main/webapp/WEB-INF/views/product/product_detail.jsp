									...
									<div class="photo_area">
										...
										<div class="als_image_viewport">
											...
											<div class="als_container">
												<div class="als_item als_normal_item" id="thum_1">
													<a>
														<img alt="작은 썸네일 이미지" class="thumbnail_img" src="img/o7.jpg">
													</a>
												</div>
												<div class="als_item als_normal_item als_item_other" id="thum_2">
													<a>
														<img alt="작은 썸네일 이미지" class="thumbnail_img" src="img/o8.jpg">
													</a>
												</div>
												<div class="als_item als_normal_item als_item_other" id="thum_3">
													<a>
														<img alt="작은 썸네일 이미지" class="thumbnail_img" src="img/o7.jpg">
													</a>
												</div>
												<div class="als_item als_normal_item als_item_other" id="thum_4">
													<a>
														<img alt="작은 썸네일 이미지" class="thumbnail_img" src="img/o8.jpg">
													</a>
												</div>
												<div class="als_item als_normal_item als_item_other" id="thum_5">
													<a>
														<img alt="작은 썸네일 이미지" class="thumbnail_img" src="img/o7.jpg">
													</a>
												</div>
												<div class="als_item als_normal_item als_item_other" id="thum_6">
													<a>
														<img alt="작은 썸네일 이미지" class="thumbnail_img" src="img/o8.jpg">
													</a>
												</div>
										...
										<div class="detail_comment">
											<section class="description">
												...
												<div class="description_text">
													강원도영월군영월읍 임야 3만2천평 <br />농림지역+관리지역 주택 가능 <br />하우스 2동 전기,
													인터넷, tv유선,상수도 설치 <br />동강 레프팅 종착지 에서 3분거리 <br />산약초 관광농원
													조성중 <br />임야 사업승인 일부 승인 <br />나머지 평수도 승인절차중 <br />벌목 모두배기 후
													약초 재조림 계획중 <br />전원생활 하면서 약초 농장 운영하기 좋다고 생각 합니다. <br />TV에
													(나는 자연인 이다)(생방송 투데이) <br />(긋모닝 대한민국) 방송 되여 홍보 하기에도 좋습니다 <br />문의
													하세요~~ <br /> <br />010오이육육4018
												</div>
											</section>
											...
											<section class="comment_title">
												<span class="comment_title_comment">댓글</span><span>(<!-- -->1<!-- -->)
												</span>
											</section>
