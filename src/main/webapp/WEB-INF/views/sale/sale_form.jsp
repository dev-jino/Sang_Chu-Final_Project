				...
				<div class="main">
						...
						<div class="description">
							<dl class="regist_image_dl" id="images_box">
								...
								<dd>
									<ul class="image_list">
										<li>
											<input id="item-input" type="file" style="display: none"/>
											<div class="up_img_box">
												<label for="item-input">
													<img src="img/site/cam.png" class="item_img" id="item_img" alt="상품 등록 이미지">
												</label>
											</div>
										</li>
										<li>
											<input id="item-input1" type="file" style="display: none"/>
											<div class="up_img_box">
												<label for="item-input1">
													<img src="img/site/cam.png" class="item_img" id="item_img1" alt="상품 등록 이미지">
												</label>
											</div>
										</li>
										<li>
											<input id="item-input2" type="file" style="display: none"/>
											<div class="up_img_box">
												<label for="item-input2">
													<img src="img/site/cam.png" class="item_img" id="item_img2" alt="상품 등록 이미지">
												</label>
											</div>
										</li>
										<li>
											<input id="item-input3" type="file" style="display: none"/>
											<div class="up_img_box">
												<label for="item-input3">
													<img src="img/site/cam.png" class="item_img" id="item_img3" alt="상품 등록 이미지">
												</label>
											</div>
										</li>
										<li>
											<input id="item-input4" type="file" style="display: none"/>
											<div class="up_img_box">
												<label for="item-input4">
													<img src="img/site/cam.png" class="item_img" id="item_img4" alt="상품 등록 이미지">
												</label>
											</div>
										</li>
									</ul>
								...
								<dd>
									<div class="item_select_box">
										<select><option value="" hidden="">카테고리</option>
											<option value="HAR0000">가구·가전</option>
											<option value="HFB0000">생활·식품</option>
											<option value="HFC0000">게임·취미</option>
											<option value="HAO0000">의류·잡화</option>
					...
					<div class="item_submit_box">
						<div class="item_area_submit_box">
							...
							<button class="btn_item_submit" type="button">상품등록 완료</button>
						</div>
					</div>
					<br>
				</div>
