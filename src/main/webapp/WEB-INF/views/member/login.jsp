...
<form>
<div class="login_id_input_area"><input type="text" value="" class="id_input" placeholder="아이디" name="id"/></div>
...
<div class="login_find_area pc_login_area"><span class="re_password"><a class="re_password_btn" href="<%=request.getContextPath()%>/find_id">아이디찾기</a></span>
<span class="gap">|</span>
<span class="re_password"><a class="re_password_btn" href="<%=request.getContextPath()%>/find_password">비밀번호찾기</a></span></div>
</form>
...
<button class="sign_text_btn">상추슈퍼</button></a></span></div>
<div class="sign_text_url">
<span class="sign_span">처음이신가요?</span>
<span><a href="<%=request.getContextPath()%>/join">
<button class="sign_text_btn">회원가입</button></a></span></div></div></div>
