							...
							<div class="my_profile_left">
								...
								<div class="my_profile_nav">
									<ul>
										...
										<li><a href="<%=request.getContextPath()%>/mypage_info_update"><span>내 정보</span></a></li>
									</ul>
								</div>
							</div>
							<h2>회원 탭 영역</h2>
								...
								<div class="tab_content">
									<div class="my_profile_item_menu">
										<ul>
											...
											<li class="active"><a class="active"  href="<%=request.getContextPath()%>/mypage_buy_list">구매 상품</a></li>
